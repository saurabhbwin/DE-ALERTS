...
Messages = {
	...
	// Generate a similar file with a language suffix containing the translated messages
		application_title : "DE Alerts",
		logoutConfirm: "Do you wish to logout?",
//		response message
		sameQuery: "This query is already here!",
		cartNotFound: "Cart not found",
		poNotFound: "Purchase order not found",
		invoiceNotFound: "Invoice not found",
		sessionExpired: "Session expired\nPlease login again to continue your work",
		serverNotResponding: "No response from the server",
		serverInternalError: "Server internal error \nFailure in retrieving data from the server. ",
		retrievingDataError: "An error occured while retrieving data from the server. ",
		allFieldRequired: "All fields are required, please try again",
		invalidUsername: "Invalid IBM Intranet User Name, please try again",
//		message to show in indicator
		loading_indicator_title : "Loading...",
		authenticating_indicator_title : "Authenticating...",
//		error messages handle by error code
		...
		error_message_401_can_not_authenticate : "Cannot authenticate. Please try again later.",
