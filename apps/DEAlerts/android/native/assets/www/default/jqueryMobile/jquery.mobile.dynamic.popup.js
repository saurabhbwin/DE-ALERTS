...
/* JavaScript content from jqueryMobile/jquery.mobile.dynamic.popup.js in folder common */
/**
    ...
    function dynamicPopup(){
        ...
        this.init = function( options ){
            ...
            if(typeof options === 'string'){
            	console.log('Sending a plain text or HTML message.');
...
//                $popupCloseBtn = $popup.find('.ui-popup-close-btn');
        ...
        this.populatePopupContent = function(){
            ...
            if(settings.content instanceof jQuery){
                console.log('jQuery object: Grab the content inside the wrapper.');
                $popupContent.html( settings.content.html() );
            } else
            // 1. Static HTML string.
            if(typeof settings.content === 'string'){
            	console.log('1. Static HTML string.');
